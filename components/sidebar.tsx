  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="bg-gradient-to-b from-[#0f0f23] via-[#1a1a3e] to-[#2d1b69] text-white flex-col fixed left-0 top-0 h-screen z-50 shadow-2xl overflow-hidden hidden lg:flex"
      >
      ...
      <motion.div
        ...
        className="bg-gradient-to-b from-[#0f0f23] via-[#1a1a3e] to-[#2d1b69] text-white flex flex-col fixed left-0 top-0 h-screen z-50 shadow-2xl overflow-hidden lg:hidden w-[70%] sm:w-[50%]"
      >
        {/* Animated Background Elements */}
        <div className="absolute inset-0 overflow-hidden">
          {/* Gradient Orbs */}
